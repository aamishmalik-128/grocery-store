                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="card product-card h-100 border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <h6 class="card-title"><a href="{{route('product',1)}}" class="text-decoration-none text-dark">Farm Fresh Eggs (12)</a></h6>
                                <div class="d-flex align-items-center mb-2">
                                    <span class="text-warning">
                                        <i class="bi bi-star-fill"></i>
                                        <i class="bi bi-star-fill"></i>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="card product-card h-100 border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                <p class="small text-muted mb-1">Fruits</p>
                                <h6 class="card-title"><a href="{{route('product',1)}}" class="text-decoration-none text-dark">Fresh Coconuts</a></h6>
                                <div class="d-flex align-items-center mb-2">
                                    <span class="text-warning">
                                        <i class="bi bi-star-fill"></i>
                                        <i class="bi bi-star-fill"></i>
