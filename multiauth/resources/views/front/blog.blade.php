            ...
            <div class="col-lg-4 col-md-6">
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title fw-bold">
                            <a href="{{route('post',1)}}" class="text-dark text-decoration-none">Easy Vegetarian Recipes for Busy Weekdays</a>
                        </h5>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title fw-bold">
                            <a href="{{route('post',1)}}" class="text-dark text-decoration-none">How to Choose the Best Fresh Produce</a>
                        </h5>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title fw-bold">
                            <a href="{{route('post',1)}}" class="text-dark text-decoration-none">Complete Guide to Protein-Rich Foods</a>
                        </h5>
