    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <h1 class="fw-bold mb-4">Welcome to SwiftStore</h1>
            ...
            <div class="col-lg-6">
                <img src="{{asset('dist-front/images/Wheat Flour.jpg')}}"  alt="FreshMart Store" class="img-fluid rounded shadow about-hero-img" >
            </div>
        </div>
    </div>
</section>
